...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        ...
        function load() {
            $.ajax({
                url: "GetExpressForStudent.ashx",
                type: "post",
                dataType: "json",
                success: function (json) {
                    if (json.Code == 0) {
                        var s = "<table cellspacing=0 style='width:100%'>";
                        s += "<tr><td>快递单号</td><td>派送员</td><td>收件人</td><td>楼号</td><td>宿舍号</td><td>派送时间</td><td>收货时间</td><td>快递状态</td><td>操作</td></tr>";
                        for (var i = 0; i < json.Data.length; i++) {
                            s += "<tr>";
                            s += "<td>" + json.Data[i].ExpressCode + "</td>";
                            s += "<td>" + json.Data[i].SenderName + "</td>";
                            ...
                            if (json.Data[i].DelegateTime == null)
                                ...
                                var ss = ChangeDateFormat(json.Data[i].ReceiveTime);
                                s += "<td>" + ss + "</td>";
                            }
